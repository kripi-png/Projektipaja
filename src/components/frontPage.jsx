...
export default class FrontPage extends React.Component {
  render() {
    alert("Kaikki näkemäsi on työn ja suunnittelun alla eikä mitään ole lyöty lukkoon.")
    return (
      <div className="main">
        <Button
          ...
          type={'text'}
          hoverInfo={'Tekstiä'}
          contentStyle={{ backgroundColor: '#820081', fontSize: "1.2em", padding: '.75em', border: "2px solid #000" }}
